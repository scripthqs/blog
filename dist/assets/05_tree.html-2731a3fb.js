import{_ as n,o as s,c as a,f as p}from"./app-4d122d87.js";const e={},t=p(`<h1 id="树-tree" tabindex="-1"><a class="header-anchor" href="#树-tree" aria-hidden="true">#</a> 树(tree)</h1><p>树有二叉树、红黑树等各种树。不过所有树的本质都是二叉树。</p><ul><li>树顶部有个根节点(root)</li><li>树的深度取决于祖先节点的数量，有几个祖先节点，深度就是几。</li><li>树的高度 = 深度的最大值</li></ul><h2 id="js-中简单的树结构" tabindex="-1"><a class="header-anchor" href="#js-中简单的树结构" aria-hidden="true">#</a> js 中简单的树结构</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token punctuation">{</span>
