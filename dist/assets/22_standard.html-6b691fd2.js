import{_ as p,r as c,o as l,c as o,b as n,e as s,d as e,f as a}from"./app-007a9be1.js";const i={},u=a(`<h1 id="css-规范-bem" tabindex="-1"><a class="header-anchor" href="#css-规范-bem" aria-hidden="true">#</a> CSS 规范 BEM</h1><p>css 一般按照以下顺序写比较好。</p><h2 id="_1-布局定位书写" tabindex="-1"><a class="header-anchor" href="#_1-布局定位书写" aria-hidden="true">#</a> 1.布局定位书写</h2><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">div</span> <span class="token punctuation">{</span>
