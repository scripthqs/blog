import{_ as p,r as o,o as i,c as l,b as n,e as s,d as e,f as t}from"./app-10c4e004.js";const r={},c=t(`<h1 id="前端集成规范" tabindex="-1"><a class="header-anchor" href="#前端集成规范" aria-hidden="true">#</a> 前端集成规范</h1><h2 id="eslint" tabindex="-1"><a class="header-anchor" href="#eslint" aria-hidden="true">#</a> eslint</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> eslint@8.22.0 <span class="token parameter variable">-D</span>
...
npx lint-staged
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="限定-node-和-npm-等包管理工具版本" tabindex="-1"><a class="header-anchor" href="#限定-node-和-npm-等包管理工具版本" aria-hidden="true">#</a> 限定 node 和 npm 等包管理工具版本</h2><p>在 package.json 中添加 engines 字段，指定 node 和 npm 的版本范围：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token punctuation">{</span>
  <span class="token string-property property">&quot;engines&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token string-property property">&quot;node&quot;</span><span class="token operator">:</span> <span class="token string">&quot;&gt;=16.0.0 &lt;19.0.0&quot;</span><span class="token punctuation">,</span>
    <span class="token string-property property">&quot;npm&quot;</span><span class="token operator">:</span> <span class="token string">&quot;&gt;=7.0.0&quot;</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>.nvmrc</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token number">18.16</span><span class="token number">.0</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,14);function f(x,j){const a=o("ExternalLinkIcon");return i(),l("div",null,[c,n("p",null,[n("a",u,[s("https://zh-hans.eslint.org/"),e(a)]),s(),d,n("a",v,[s("https://eslint.org/"),e(a)])]),k,n("p",null,[n("a",m,[s("https://prettier.io/"),e(a)])]),b,n("ul",null,[n("li",null,[n("a",g,[s("https://typicode.github.io/husky/zh/"),e(a)])]),n("li",null,[n("a",h,[s("https://www.npmjs.com/package/lint-staged"),e(a)])]),n("li",null,[n("a",q,[s("https://www.npmjs.com/package/@commitlint/config-conventional"),e(a)])])]),y])}const w=p(r,[["render",f],["__file","03_lint.html.vue"]]);export{w as default};
