import{_ as n,o as s,c as a,f as t}from"./app-c6441670.js";const p={},c=t(`<h1 id="_9-手写消息订阅与发布" tabindex="-1"><a class="header-anchor" href="#_9-手写消息订阅与发布" aria-hidden="true">#</a> 9 手写消息订阅与发布</h1><h2 id="_9-1-api-说明" tabindex="-1"><a class="header-anchor" href="#_9-1-api-说明" aria-hidden="true">#</a> 9.1 API 说明</h2><ol><li>PubSub: 包含所有功能的订阅/发布消息的管理者</li><li>PubSub.subscribe(msg, subscriber): 订阅消息: 指定消息名和订阅者回调函数</li><li>PubSub.publish(msg, data): 异步发布消息: 指定消息名和数据</li><li>PubSub.publishSync(msg, data): 同步发布消息: 指定消息名和数据</li><li>PubSub.unsubscribe(flag): 取消订阅: 根据标识取消某个或某些消息的订阅</li></ol><h2 id="_9-2-编码实现" tabindex="-1"><a class="header-anchor" href="#_9-2-编码实现" aria-hidden="true">#</a> 9.2 编码实现</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">/* 
自定义消息订阅与发布
*/</span>
