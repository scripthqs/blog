import{_ as t,r as o,o as c,c as l,b as n,e as a,d as i,f as s}from"./app-c6441670.js";const r={},p=s(`<h1 id="过渡-transition" tabindex="-1"><a class="header-anchor" href="#过渡-transition" aria-hidden="true">#</a> 过渡 transition</h1><p>过渡 transition 属性可以指定一个属性发生变化时的切换方式。常常和 .hover 搭配使用。</p><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token property">transition</span><span class="token punctuation">:</span> 变化的属性 持续时间 运动曲线 延迟时间<span class="token punctuation">;</span>
