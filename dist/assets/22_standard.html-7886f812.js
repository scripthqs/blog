import{_ as n,o as s,c as a,f as e}from"./app-c6441670.js";const p={},t=e(`<h1 id="书写规范" tabindex="-1"><a class="header-anchor" href="#书写规范" aria-hidden="true">#</a> 书写规范</h1><p>css 一般按照以下顺序写比较好。</p><h2 id="_1-布局定位书写" tabindex="-1"><a class="header-anchor" href="#_1-布局定位书写" aria-hidden="true">#</a> 1.布局定位书写</h2><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">div</span> <span class="token punctuation">{</span>
