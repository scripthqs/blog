import{_ as n,o as s,c as a,f as e}from"./app-4d122d87.js";const t={},p=e(`<h1 id="执行上下文与执行上下文栈" tabindex="-1"><a class="header-anchor" href="#执行上下文与执行上下文栈" aria-hidden="true">#</a> 执行上下文与执行上下文栈</h1><h2 id="变量提升与函数提升" tabindex="-1"><a class="header-anchor" href="#变量提升与函数提升" aria-hidden="true">#</a> 变量提升与函数提升</h2><ul><li>变量声明提升：通过 var 声明的变量，在定义语句前就可以访问到，值为 undefined</li><li>函数声明提升：通过 function 声明的函数（<strong>函数声明</strong>），在之前就可以直接调用，值为函数对象</li><li><strong>先执行变量提升再执行函数提升。</strong></li></ul><h2 id="执行上下文" tabindex="-1"><a class="header-anchor" href="#执行上下文" aria-hidden="true">#</a> 执行上下文</h2><p>执行上下文(Execution Contexts，简称 ECS)是当前代码的执行环境。</p><p>代码分为全局代码和局部（函数）代码。</p><p>执行上下文主要是三种类型：</p><ul><li>全局执行上下文</li><li>函数执行上下文</li><li>eval 执行上下文，很少用</li></ul><h3 id="全局执行上下文" tabindex="-1"><a class="header-anchor" href="#全局执行上下文" aria-hidden="true">#</a> 全局执行上下文</h3><ol><li><p>在执行全局代码<strong>前</strong>，将<strong>window</strong>确定为<strong>全局执行上下文</strong></p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">//window</span>
