import{_ as n,o as s,c as a,f as p}from"./app-75be3b02.js";const t={},e=p(`<h1 id="toref-和-torefs" tabindex="-1"><a class="header-anchor" href="#toref-和-torefs" aria-hidden="true">#</a> toRef 和 toRefs</h1><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> info <span class="token operator">=</span> <span class="token function">reactive</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
