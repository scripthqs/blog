<template><div><h1 id="nodejs-综合应用" tabindex="-1"><a class="header-anchor" href="#nodejs-综合应用" aria-hidden="true">#</a> nodejs 综合应用</h1>
<p>由于 Vue 项目的个人中心需要登录，此处需要设计 2 个接口，分别是：</p>
<ul>
<li>登录</li>
<li>获取用户信息</li>
</ul>
<blockquote>
<p>用户数据可以存储在 MongoDB 中。</p>
<p>约定：</p>
<ul>
<li>库名：maizuo</li>
<li>表名：users</li>
...
<p>接下来就可以使用 NodeJS 来创建后端服务器来提供 API 接口运行环境了。</p>
<h2 id="_1-用户登录接口" tabindex="-1"><a class="header-anchor" href="#_1-用户登录接口" aria-hidden="true">#</a> 1.用户登录接口</h2>
<p>① 新建一个空文件夹，在其中初始化 NodeJS 项目</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>② 新建<code v-pre>http.js</code>文件，创建一个 express 服务器</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>③ 使用<code v-pre>md5</code>模块来编写一个对密码加密的中间件</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 密码加密中间件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>④ 调用写好的密码加密中间件生成一个用户的初始密码用于后面做登录使用</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 获取初始化密码（用完即删）</span>
...
<p>POST 形式访问<code v-pre>/init</code>获得密码后就得到了一个完整的用户数据，此时可以将数据写入到 MongoDB 中。</p>
<p>如果我们自己的加密方式与讲义的代码不一样，请根据自己加密得到的密码来实际替换下面的 password 字段的值。</p>
</blockquote>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>将模拟好的数据，写入到数据库中，以便后面做登录操作：</p>
<p><img src="https://storage.lynnn.cn/assets/markdown/91147/pictures/2020/12/49445839b58961aef64d39fec96c93fa97b2adc9.png?sign=5f921a04479fe5b4d775ebcc94a1aa11&amp;t=5fe02f7c" alt="mongoDB"></p>
<p>⑤ 配置<code v-pre>jsonwebtoken</code>模块需要用的<code v-pre>secret</code>，并在代码中读取供后续使用</p>
<blockquote>
<p>在 node 项目目录中创建一个.env（Linux 以.开头都为隐藏文件）并在此文件中写入 jwt 加密所需要的秘钥。同时，.env 文件不要上传到 Github 上（.gitignore 文件中声明忽略）。</p>
</blockquote>
<p><img src="https://storage.lynnn.cn/assets/markdown/91147/pictures/2020/10/204d74229dcc25e9147bd73e6b1d01a86bcccffc.png?sign=33e1a22a1fbcf1e0f58f2352a37edfb9&amp;t=5f868353" alt="secret配置"></p>
<p>在代码中读取<code v-pre>secret</code></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 读取JWT的密钥</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>⑥ 引入<code v-pre>mongoose</code></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 引入mongoose</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>⑦ 创建登录路由<code v-pre>/api/v1/user/login</code>实现用户名密码校验，并判断校验结果做出响应</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 登录验证接口</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="获取用户信息接口" tabindex="-1"><a class="header-anchor" href="#获取用户信息接口" aria-hidden="true">#</a> 获取用户信息接口</h2>
<p>个人中心的信息是用户<strong>登录成功后</strong>才能进行的页面展示，在请求数据时，后台接口一定要判断当前请求是否有 token，且 token 解密后一定是一个合法数据。</p>
<p><strong>接口需求</strong>：依据客户端传递给服务端的用户编号<code v-pre>userId</code>，在验证通过<code v-pre>jwt</code>后输出对应用户信息</p>
<blockquote>
<p>注意点：</p>
<p>有些企业提供的接口 jwt 所返回的 token 格式可能会在原有 token 之前拼接一个<code v-pre>持有者（空格）</code>的信息，例如用户<code v-pre>zhangsan</code>获取到的 token：</p>
</blockquote>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>zhangsan eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjMxMTY3NTA5LCJtb2JpbGUiOiIxODUxMjM0NTY3OCIsImlhdCI6MTYwMjY0OTg2NX0.tVByVZYu4s5dgzLZwR00HHW7QZ0gkYpVXaVNhCdawbU
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote>
<p>如果是上述在接收 token 的时候需要注意，别获取错误了。注意，验证是否合法只用 token，前面的持有者不用。</p>
</blockquote>
<p>① 定义获取并验证<code v-pre>jwt</code>的中间件</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 中间件：验证客户端发送过来的token</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>app<span class="token punctuation">.</span><span class="token function">post</span><span class="token punctuation">(</span><span class="token string">"/api/v1/user/info"</span><span class="token punctuation">,</span> checkToken<span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token parameter">req<span class="token punctuation">,</span> res</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
...
<li>RMVC
<ul>
<li>R：router，路由，客户端发起请求与服务端响应之间的映射（app.get/post/put/delete..）</li>
<li>M：model，模型，用来处理业务逻辑的，但是业务逻辑可能与数据库与关系</li>
<li>V：view（无），视图，展示用户看的页面</li>
<li>C：controller，控制器，请求响应流程控制的（其中包含了若干个用于响应的方法）</li>
</ul>
</li>
</ul>
<p>现在要拆的有：路由、中间件、模型、控制器。</p>
<p>推荐顺序：模型、中间件、路由、控制器</p>
<p>各个文件的存放位置：</p>
<blockquote>
<ul>
<li>
<p>[x] 模型：app/models/*.js</p>
</li>
<li>
<p>[x] 中间件：app/middlewares/*.js</p>
</li>
<li>
<p>[x] 路由：routers/分隔目录/*.js</p>
</li>
<li>
<p>[x] 控制器：app/controllers/*.js</p>
</li>
<li>
<p>[x] DB 连接配置：config/*.js</p>
</li>
<li>
<p>[x] Schema：database/migrations/create_xxxxx_table.js</p>
</li>
</ul>
</blockquote>
<p>拆分思想目录结构参考：<a href="https://github.com/laravel/laravel" target="_blank" rel="noopener noreferrer">https://github.com/laravel/laravel<ExternalLinkIcon/></a></p>
</div></template>
