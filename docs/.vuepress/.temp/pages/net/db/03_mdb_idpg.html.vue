<template><div><h1 id="mongodb-增删改查" tabindex="-1"><a class="header-anchor" href="#mongodb-增删改查" aria-hidden="true">#</a> MongoDB 增删改查</h1>
<h2 id="添加" tabindex="-1"><a class="header-anchor" href="#添加" aria-hidden="true">#</a> 添加</h2>
<p>向集合中添加文档数据：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 添加单条文档数据</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>例如</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 使用`insertOne`添加单个数据到`shop`库的`members`集合</span>
...
<p>实际使用的比较多的是：insertOne()、insert({})，插入多个的形式仅作了解。</p>
</blockquote>
<h2 id="查询" tabindex="-1"><a class="header-anchor" href="#查询" aria-hidden="true">#</a> 查询</h2>
<h3 id="查询所有的数据" tabindex="-1"><a class="header-anchor" href="#查询所有的数据" aria-hidden="true">#</a> 查询所有的数据</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>db.表名/集合名.find<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>    <span class="token comment"># 获取全部</span>
...
<p><code v-pre>{ }</code>用于条件限制，当没条件的时候，上述两个用法效果一致
关于<code v-pre>_id</code></p>
<p><strong><em>{ &quot;_id&quot; : ObjectId(&quot;5c0fa4758878caa23d36c0fb&quot;), &quot;name&quot; : &quot;aaa&quot; }</em></strong></p>
<p>objectID 类型
ObjectId 对象对象数据组成：时间戳 |机器码|PID|计数器 <strong>系统自动生成</strong> &gt; _id 的键值我们可以自己输入，但是不能重复，因此为了避免工作的复杂建议不要人为的去干预_id 的是很工程</p>
</blockquote>
<h3 id="带条件查询" tabindex="-1"><a class="header-anchor" href="#带条件查询" aria-hidden="true">#</a> 带条件查询</h3>
<blockquote>
<p>此处允许使用多个条件，如果有就在&quot;{}&quot;中多写几个，<strong>默认是“且”条件关系</strong>。</p>
</blockquote>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>db.表名/集合名.find<span class="token punctuation">(</span><span class="token punctuation">{</span>key:value<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="字段显示控制" tabindex="-1"><a class="header-anchor" href="#字段显示控制" aria-hidden="true">#</a> 字段显示控制</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>db.表名/集合名.find<span class="token punctuation">(</span>条件,<span class="token punctuation">{</span>字段名:0或1,<span class="token punctuation">..</span><span class="token punctuation">..</span><span class="token punctuation">}</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="逻辑运算" tabindex="-1"><a class="header-anchor" href="#逻辑运算" aria-hidden="true">#</a> 逻辑运算</h3>
<ul>
<li><code v-pre>$gt</code> &gt;</li>
<li><code v-pre>$gte</code>&gt;=</li>
<li><code v-pre>$lt</code>&lt;</li>
<li><code v-pre>$lte</code>&lt;=</li>
<li><code v-pre>$ne</code>!=</li>
<li><code v-pre>$in:[1,2,3]</code> 集合，符合 1 或 2 或 3 的数据</li>
<li><code v-pre>默认,分割的各种条件就是且关系</code></li>
<li><code v-pre>$or:[{条件1},{条件2}]</code> 集合，符合 1 或 2 或 3 的数据</li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">### 条件表达式</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="模糊查询" tabindex="-1"><a class="header-anchor" href="#模糊查询" aria-hidden="true">#</a> 模糊查询</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#正则</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="统计" tabindex="-1"><a class="header-anchor" href="#统计" aria-hidden="true">#</a> 统计</h3>
<p>计数操作：数记录的数量</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#统计总记录数</span>
...
<p>注意点：find()顺序是否可以与 count()颠倒。</p>
<p>count 不能与 find 的顺序交换</p>
</blockquote>
<h3 id="排序" tabindex="-1"><a class="header-anchor" href="#排序" aria-hidden="true">#</a> 排序</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 排序</span>
...
db.表名/集合名.find<span class="token punctuation">(</span><span class="token punctuation">)</span>.sort<span class="token punctuation">(</span><span class="token punctuation">{</span>age:-1<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-8-分页-实用" tabindex="-1"><a class="header-anchor" href="#_2-8-分页-实用" aria-hidden="true">#</a> 2.8 分页（实用）</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 指定获取几条  skip/limit   分页</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="更新" tabindex="-1"><a class="header-anchor" href="#更新" aria-hidden="true">#</a> 更新</h2>
<p>根据条件修改已存在集合中的文档数据：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 更新是要有条件的，没有条件在数据库层面来讲是可以更新的，但是实际是没有对应的业务需求</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="删除-了解" tabindex="-1"><a class="header-anchor" href="#删除-了解" aria-hidden="true">#</a> 删除（了解）</h2>
<p>删除在实际开发的时候一般不用，<strong>正常做程序开发的时候所使用的删除实际上是修改</strong>。</p>
<p>删除分为：真删除（物理删除）、假删除（逻辑删除）。</p>
<p>删除集合中已存在的文档数据：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 删除单条文档</span>
