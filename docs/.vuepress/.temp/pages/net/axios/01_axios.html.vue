<template><div><h1 id="axios-基础" tabindex="-1"><a class="header-anchor" href="#axios-基础" aria-hidden="true">#</a> axios 基础</h1>
<h2 id="axios-简介" tabindex="-1"><a class="header-anchor" href="#axios-简介" aria-hidden="true">#</a> axios 简介</h2>
<ol>
<li>前端最流行的 ajax 请求库</li>
<li>react/vue 官方都推荐使用 axios 发 ajax 请求</li>
<li><a href="https://github.com/axios/axios" target="_blank" rel="noopener noreferrer">文档: https://github.com/axios/axios<ExternalLinkIcon/></a></li>
</ol>
<p>调用 axios 方法，<strong>返回的是一个 promise 对象</strong></p>
<blockquote>
<p>接口测试网站<a href="https://httpbin.org/#/" target="_blank" rel="noopener noreferrer">https://httpbin.org/#/<ExternalLinkIcon/></a></p>
</blockquote>
<h2 id="axios-特点" tabindex="-1"><a class="header-anchor" href="#axios-特点" aria-hidden="true">#</a> axios 特点</h2>
<ol>
<li>基于 xhr + promise 的异步 ajax 请求库</li>
...
<h2 id="axios-常用语法" tabindex="-1"><a class="header-anchor" href="#axios-常用语法" aria-hidden="true">#</a> axios 常用语法</h2>
<p><code v-pre>axios(config)</code>: 通用/最本质的发任意类型请求的方式
<code v-pre>axios(url[, config])</code>: 可以只指定 url 发 get 请求
<code v-pre>axios.request(config)</code>: 等同于 axios(config)
<code v-pre>axios.get(url[, config])</code>: 发 get 请求
<code v-pre>axios.delete(url[, config])</code>: 发 delete 请求
<code v-pre>axios.post(url[, data, config])</code>: 发 post 请求
<code v-pre>axios.put(url[, data, config])</code>: 发 put 请求
<code v-pre>axios.defaults.xxx</code>: 请求的默认全局配置（method\baseURL\params\timeout…）
<code v-pre>axios.interceptors.request.use()</code>: 添加请求拦截器
<code v-pre>axios.interceptors.response.use()</code>: 添加响应拦截器
<code v-pre>axios.create([config])</code>: 创建一个新的 axios(它没有下面的功能)
<code v-pre>axios.Cancel()</code>: 用于创建取消请求的错误对象
<code v-pre>axios.CancelToken()</code>: 用于创建取消请求的 token 对象
<code v-pre>axios.isCancel()</code>: 是否是一个取消请求的错误
<code v-pre>axios.all(promises)</code>: 用于批量执行多个异步请求
<code v-pre>axios.spread()</code>: 用来指定接收所有成功数据的回调函数的方法</p>
<!-- ![axios](./images/axios.png) -->
<p><img src="https://raw.githubusercontent.com/scripthqs/assets/master/blog/axios.png" alt="axios"></p>
<h2 id="axios-的基本使用" tabindex="-1"><a class="header-anchor" href="#axios-的基本使用" aria-hidden="true">#</a> axios 的基本使用</h2>
<h3 id="axios-发送-get-请求" tabindex="-1"><a class="header-anchor" href="#axios-发送-get-请求" aria-hidden="true">#</a> axios 发送 get 请求</h3>
<p>发起 GET 请求：<strong>通过 params 传参</strong></p>
<ol>
<li>
<p>通过<code v-pre>axios({})</code>通用方式发送</p>
...
<li>
<p>通过<code v-pre>axios('url',{})</code>发送</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token function">axios</span><span class="token punctuation">(</span><span class="token string">"https://autumnfish.cn/top/playlist"</span><span class="token punctuation">,</span> <span class="token punctuation">{</span>
  <span class="token comment">// 请求方式</span>
  <span class="token literal-property property">method</span><span class="token operator">:</span> <span class="token string">"GET"</span><span class="token punctuation">,</span>
  <span class="token literal-property property">params</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">limit</span><span class="token operator">:</span> <span class="token number">10</span><span class="token punctuation">,</span>
...
<li>
<p>通过<code v-pre>axios.get('url',{})</code>发送</p>
<p>get 请求传递 2 个参数：</p>
<ol>
<li>请求的地址</li>
<li>表示配置信息，</li>
</ol>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//  方式1</span>
...
<h3 id="axios-发送-post-请求" tabindex="-1"><a class="header-anchor" href="#axios-发送-post-请求" aria-hidden="true">#</a> axios 发送 post 请求</h3>
<p>发起 POST 请求：<strong>通过 data 传参</strong>，<strong>上面的前两种方法，get 和 post 都可以使用。</strong></p>
<p>通过<code v-pre>axios.post(&quot;&quot;,{},{})</code>发送</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>axios<span class="token punctuation">.</span><span class="token function">post</span><span class="token punctuation">(</span><span class="token string">""</span><span class="token punctuation">,</span> <span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">,</span> <span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>post 请求传递 3 个参数，</p>
<ol>
<li>请求地址</li>
<li>传递的数据，在请求体中传递，默认是 json 格式</li>
<li>配置的信息，header 等</li>
</ol>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 方式1</span>
axios
...
axios
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以使用 async 和 await 简化 promise</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>  <span class="token comment">// 如果调用某个方法的返回值是 Promise 实例，则前面可以添加 await！</span>
...
<li>使用结构赋值，从 axios 封装的大对象中，把 data 属性解构出来</li>
<li>把解构出来的 data 属性，使用冒号<code v-pre>:</code>进行重命名{data: res}</li>
</ol>
</div></template>
