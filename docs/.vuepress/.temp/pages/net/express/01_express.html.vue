<template><div><h1 id="express" tabindex="-1"><a class="header-anchor" href="#express" aria-hidden="true">#</a> Express</h1>
<h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h2>
<p>网址：<a href="https://www.expressjs.com.cn/" target="_blank" rel="noopener noreferrer">https://www.expressjs.com.cn/<ExternalLinkIcon/></a></p>
<p>Express 是基于 Node.js 平台，<code v-pre>快速、开放、极简</code>的 Web 开发框架。<strong>搭建 web 服务器</strong></p>
<p>Express 的本质：就是一个 npm 上的第三方包，提供了快速创建 Web 服务器的便捷方法。</p>
<p>使用 Express 开发框架可以非常方便、快速的创建 Web 网站的服务器或 API 接口的服务器</p>
<h2 id="安装-express" tabindex="-1"><a class="header-anchor" href="#安装-express" aria-hidden="true">#</a> 安装 Express</h2>
<p>在项目目录中，打开 cmd 命令窗口，执行如下命令：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> init <span class="token parameter variable">-y</span>  <span class="token comment"># 如果没有项目则先初始化</span>
<span class="token function">npm</span> i <span class="token parameter variable">-S</span> express
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="创建-web-服务" tabindex="-1"><a class="header-anchor" href="#创建-web-服务" aria-hidden="true">#</a> 创建 web 服务</h2>
<p>基本遵循之前的四个步骤：</p>
<ol>
<li>导入 express 模块</li>
<li>创建 web 实例</li>
...
<p>扩展：查看当前监听的端口<code v-pre>8080</code>是否启动</p>
</blockquote>
<ul>
<li>windows 平台</li>
<li>“|”，管道，变量修饰符，过滤器</li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">netstat</span> <span class="token parameter variable">-ano</span> <span class="token operator">|</span> findStr <span class="token number">8080</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>Unix 系平台（macOS、Linux）</li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">netstat</span> <span class="token parameter variable">-tnpl</span> <span class="token operator">|</span> <span class="token function">grep</span> <span class="token number">8080</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>实践</strong>：</p>
<p><strong>手写一个服务器软件，启动后要求用户访问根“/”输出<code v-pre>hello world</code>，用户访问<code v-pre>/html5</code>输出<code v-pre>2004</code>，用于通过 post 方式访问/post 则输出<code v-pre>post</code>。</strong></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 1. 导入模块</span>
...
<p>地址在匹配的时候是自上而下，必须同时匹配<code v-pre>方法</code>与<code v-pre>路径</code>。</p>
</blockquote>
</div></template>
