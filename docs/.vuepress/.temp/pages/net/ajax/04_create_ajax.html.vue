<template><div><h1 id="xhr-基础" tabindex="-1"><a class="header-anchor" href="#xhr-基础" aria-hidden="true">#</a> XHR 基础</h1>
<h2 id="xhr-简介" tabindex="-1"><a class="header-anchor" href="#xhr-简介" aria-hidden="true">#</a> XHR 简介</h2>
<ol>
<li>使用<code v-pre>XMLHttpRequest</code> (XHR)对象可以与服务器交互, 也就是发送 ajax 请求</li>
<li>前端可以获取到数据，而无需让整个的页面刷新。</li>
<li>这使得 Web 页面可以只更新页面的局部，而不影响用户的操作。</li>
</ol>
<p><a href="https://developer.mozilla.org/zh-CN/docs/Web/API/XMLHttpRequest/XMLHttpRequest" target="_blank" rel="noopener noreferrer"><code v-pre>XMLHttpRequest()</code><ExternalLinkIcon/></a></p>
<p>该构造函数用于初始化一个 <code v-pre>XMLHttpRequest</code> 实例对象，AJAX 的所有操作都是通过该对象进行的</p>
<blockquote>
<p>接口测试网站<a href="https://httpbin.org/#/" target="_blank" rel="noopener noreferrer">https://httpbin.org/#/<ExternalLinkIcon/></a></p>
</blockquote>
<h2 id="xhr-使用步骤" tabindex="-1"><a class="header-anchor" href="#xhr-使用步骤" aria-hidden="true">#</a> XHR 使用步骤</h2>
<ol>
<li>创建网络请求的 ajax 对象，使用 XMLHttpRequest</li>
<li>通过 open 方法配置网络请求</li>
<li>发送 send 请求</li>
<li>监听 XMLHttpRequest 对象状态的变化，或者监听 onload 事件</li>
</ol>
<h3 id="创建-xmlhttprequest-对象" tabindex="-1"><a class="header-anchor" href="#创建-xmlhttprequest-对象" aria-hidden="true">#</a> 创建 XMLHttpRequest 对象</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> xhr <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">XMLHttpRequest</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="设置请求信息-请求方法和-url" tabindex="-1"><a class="header-anchor" href="#设置请求信息-请求方法和-url" aria-hidden="true">#</a> 设置请求信息（请求方法和 url）</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="发送请求" tabindex="-1"><a class="header-anchor" href="#发送请求" aria-hidden="true">#</a> 发送请求</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>xhr<span class="token punctuation">.</span><span class="token function">send</span><span class="token punctuation">(</span>body<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">//get请求不传 body 参数，只有post请求使用</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="接收响应" tabindex="-1"><a class="header-anchor" href="#接收响应" aria-hidden="true">#</a> 接收响应</h3>
<p>事件绑定，处理服务端返回的结果</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//xhr.responseXML 接收 xml格式 的响应数据</span>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>除了 onreadystatechange 还有其他事件可以监听</p>
<ul>
...
<h2 id="响应数据和响应类型" tabindex="-1"><a class="header-anchor" href="#响应数据和响应类型" aria-hidden="true">#</a> 响应数据和响应类型</h2>
<p>发送请求后，对应的结果是 response 属性，返回的类型取决于 responseType 的属性设置，如果将 responseType 的值设置为空字符串，则会使用 text 作为默认值，目前服务器基本返回的都是 json 数据，直接设置为 json 即可。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>xhr<span class="token punctuation">.</span>responseType <span class="token operator">=</span> <span class="token string">"json"</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="响应状态-status" tabindex="-1"><a class="header-anchor" href="#响应状态-status" aria-hidden="true">#</a> 响应状态 status</h2>
<p>可以通过 status 和 statusText 来获取，status 返回响应状态码</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>xhr<span class="token punctuation">.</span>status<span class="token punctuation">;</span>
xhr<span class="token punctuation">.</span>statusText<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="get-post-参数传递" tabindex="-1"><a class="header-anchor" href="#get-post-参数传递" aria-hidden="true">#</a> get/post 参数传递</h2>
<p>常见传递给服务器数据方式：</p>
<ul>
<li>get 请求的 query 参数</li>
<li>post 请求 x-www-form-urlencoded 格式</li>
<li>post 请求 formData 格式</li>
<li>post 请求 JSON 格式</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>sendBtn<span class="token punctuation">.</span><span class="token function-variable function">onclick</span> <span class="token operator">=</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="取消请求和超时时间" tabindex="-1"><a class="header-anchor" href="#取消请求和超时时间" aria-hidden="true">#</a> 取消请求和超时时间</h2>
