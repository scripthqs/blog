...
<h2 id="less-介绍" tabindex="-1"><a class="header-anchor" href="#less-介绍" aria-hidden="true">#</a> less 介绍</h2>
<p>less 是一门 css 预处理语言，less 是 css 增强版，通过 less 可以编写更少的代码实现更强大的样式。</p>
<p>常见的 css 预处理器：sass、less、stylus</p>
<h2 id="less-变量" tabindex="-1"><a class="header-anchor" href="#less-变量" aria-hidden="true">#</a> less 变量</h2>
<p>变量时指没有固定的值，可以改变的。因为 css 中的一些颜色和数值经常使用。</p>
<div class="language-css line-numbers-mode" data-ext="css"><pre v-pre class="language-css"><code>@<span class="token property">变量</span><span class="token punctuation">:</span> 值<span class="token punctuation">;</span>
...
<li>
<p>原生 css 支持设置变量，语法<code v-pre>--*</code>：</p>
<ul>
<li><code v-pre>--color:red</code></li>
</ul>
</li>
<li>
<p>后面通过 var 引用，语法<code v-pre>var(--*)</code></p>
<ul>
<li><code v-pre>var(--color)</code></li>
</ul>
</li>
<li>
<p>原生 css 支持计算，计算函数：</p>
</li>
<li>
<p><code v-pre>calc()</code></p>
</li>
</ul>
<p>less 中添加了许多的新特性，语法大体和 css 一致，但是 less 增添了许多 css 的扩展，浏览器不能直接执行 less 代码，要执行必须将 less 转化 css，再由浏览器执行。在 <code v-pre>vscode</code>下载<code v-pre>Easy LESS</code>插件。</p>
<ul>
<li>创建<code v-pre>style.less</code>的文件，文件名必须是<code v-pre>.less</code></li>
<li>保存时插件会自动生成一个<code v-pre>.css</code>文件</li>
<li>//是 less 的单行注释，/**/多行注释</li>
<li>在变量中可以存储一个任意的值，方便修改</li>
<li>变量的语法：<code v-pre>@变量名:变量值;</code>，变量值可以时颜色、尺寸|、路径、属性名等等
<ul>
<li>一般使用时，直接写<code v-pre>@变量名</code>即可，方便修改。</li>
<li>作为类名或一部分值使用时，<code v-pre>@{变量名}</code>使用。</li>
</ul>
</li>
<li>可以在变量声明前就使用变量</li>
<li><code v-pre>&amp;</code>相当于自身外边那个选择器</li>
<li><code v-pre>:extend()</code>为当前选择器扩展分组</li>
<li><code v-pre>.选择器();</code>直接对指定样式进行引用，<code v-pre>mixin</code>混合</li>
<li>使用类选择器时可以在选择器后面加一个括号，此时就创建了一个 minxi 函数。
<ul>
<li><code v-pre>.xuzeqi(){}</code>，之后直接引用。<code v-pre>.xunzeqi;</code></li>
</ul>
</li>
<li><code v-pre>average()</code>可以取值的平均值。可以填两个颜色。</li>
<li><code v-pre>darken(red,20%)</code>可以加深颜色</li>
<li>less 中可以直接将所有数值直接运算<code v-pre>+ - * /</code>，less 除法时需要用括号括起来。</li>
<li><code v-pre>@import &quot;其他less路径&quot;</code>可以将其他的 less 引入到当前的 less 中。</li>
<li><code v-pre>.map</code></li>
</ul>
<div class="language-less line-numbers-mode" data-ext="less"><pre v-pre class="language-less"><code><span class="token selector">"less.compile":</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="mixin-混合函数" tabindex="-1"><a class="header-anchor" href="#mixin-混合函数" aria-hidden="true">#</a> mixin 混合函数</h2>
<p>在混合函数中可以直接设置变量</p>
<div class="language-less line-numbers-mode" data-ext="less"><pre v-pre class="language-less"><code><span class="token selector">.test(<span class="token variable">@w</span>,<span class="token variable">@h</span>)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>调用混合函数，按照顺序传递参数。可以直接把名字写好，此时就不用按顺序。</p>
<div class="language-less line-numbers-mode" data-ext="less"><pre v-pre class="language-less"><code><span class="token selector">.test(<span class="token variable">@w</span>,<span class="token variable">@h</span>)</span> <span class="token punctuation">{</span>
  <span class="token property">width</span><span class="token punctuation">:</span> <span class="token variable">@w</span><span class="token punctuation">;</span>
  <span class="token property">height</span><span class="token punctuation">:</span> <span class="token variable">@h</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>定义值，定义几个必须传几个参数，可以在定义时直接指定默认值。</p>
<div class="language-less line-numbers-mode" data-ext="less"><pre v-pre class="language-less"><code><span class="token selector">.test(<span class="token variable">@w</span>:200px,<span class="token variable">@h</span>:100px)</span> <span class="token punctuation">{</span>
  <span class="token property">width</span><span class="token punctuation">:</span> <span class="token variable">@w</span><span class="token punctuation">;</span>
  <span class="token property">height</span><span class="token punctuation">:</span> <span class="token variable">@h</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
<span class="token selector">div</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="less-样式" tabindex="-1"><a class="header-anchor" href="#less-样式" aria-hidden="true">#</a> less 样式</h2>
<p>less 兼容 less，支持变量、嵌套</p>
<div class="language-less line-numbers-mode" data-ext="less"><pre v-pre class="language-less"><code><span class="token comment">// 1.兼容CSS代码</span>
...
<div class="language-less line-numbers-mode" data-ext="less"><pre v-pre class="language-less"><code><span class="token comment">// 1.运算</span>
<span class="token comment">// .box {</span>
<span class="token comment">//   font-size: 20px;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>less 像 js 一样，支持继承，函数，导入等功能</p>
<div class="language-less line-numbers-mode" data-ext="less"><pre v-pre class="language-less"><code><span class="token comment">// 1.extend</span>
