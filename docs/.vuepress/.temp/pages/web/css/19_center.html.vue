<template><div><h1 id="居中问题" tabindex="-1"><a class="header-anchor" href="#居中问题" aria-hidden="true">#</a> 居中问题</h1>
<h2 id="行内元素居中" tabindex="-1"><a class="header-anchor" href="#行内元素居中" aria-hidden="true">#</a> 行内元素居中</h2>
<p>行内元素（文字、图片等）水平垂直居中比较简单</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="块级元素居中" tabindex="-1"><a class="header-anchor" href="#块级元素居中" aria-hidden="true">#</a> 块级元素居中</h2>
<p>在标准流中，盒子在父亲里居中（水平方向看），可以将其设置<code v-pre>margin: 0 auto</code>属性。</p>
<div class="language-css line-numbers-mode" data-ext="css"><pre v-pre class="language-css"><code><span class="token selector">.father</span> <span class="token punctuation">{</span>
...
<ul>
<li>要求指定子元素的宽高，才能写出 <code v-pre>margin-top</code> 和 <code v-pre>margin-left</code> 的属性值。</li>
<li>在通常情况下，对那些需要居中的元素来说，其宽高往往是由其内容来决定的，不建议固定宽高。</li>
</ul>
<p>方法 2（推荐）：</p>
<div class="language-css line-numbers-mode" data-ext="css"><pre v-pre class="language-css"><code><span class="token selector">.father</span> <span class="token punctuation">{</span>
  <span class="token property">position</span><span class="token punctuation">:</span> relative<span class="token punctuation">;</span> <span class="token comment">/*父元素开启相对定位*/</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>translate()</strong> 函数中使用百分比值时，是以这个元素自身的宽度和高度为基准进行换算和移动的（<strong>动态计算宽高</strong>）。</p>
<h2 id="flex" tabindex="-1"><a class="header-anchor" href="#flex" aria-hidden="true">#</a> flex</h2>
