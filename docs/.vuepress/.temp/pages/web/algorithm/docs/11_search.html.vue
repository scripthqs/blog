<template><div><h1 id="分治、动态规划、贪心算法" tabindex="-1"><a class="header-anchor" href="#分治、动态规划、贪心算法" aria-hidden="true">#</a> 分治、动态规划、贪心算法</h1>
<h2 id="二分搜索" tabindex="-1"><a class="header-anchor" href="#二分搜索" aria-hidden="true">#</a> 二分搜索</h2>
<p>二分搜索，二分查找，也叫折半查找。二分搜索类似一种分治思想。</p>
<ul>
<li>数组必须是有序的，且不存在重复项</li>
</ul>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="分治" tabindex="-1"><a class="header-anchor" href="#分治" aria-hidden="true">#</a> 分治</h2>
<p>一个大问题，分成小问题，递归解决小问题，将结果合并从而解决原来的大问题</p>
<h2 id="动态规划" tabindex="-1"><a class="header-anchor" href="#动态规划" aria-hidden="true">#</a> 动态规划</h2>
<p>动态规划就是把分治思想优化，将分治重复的问题，单独保存起来</p>
<h2 id="贪心算法" tabindex="-1"><a class="header-anchor" href="#贪心算法" aria-hidden="true">#</a> 贪心算法</h2>
<p>在求解问题时，总是做出当前看来最好的选择，不从整体考虑，局部最优</p>
</div></template>
