<template><div><h1 id="map" tabindex="-1"><a class="header-anchor" href="#map" aria-hidden="true">#</a> Map</h1>
<p>Map 是一种叫做字典的数据结构，Map 字典是以[key, value] 的形式储存。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//Map的构建方式</span>
...
<li>set 设置 key,value，新增或者修改</li>
<li>get 获取 key,value，查询</li>
<li>delete 删除元素，返回 boolean 值</li>
<li>size 返回键值对个数</li>
<li>has 检测集合中是否包含某个元素，返回 boolean 值</li>
<li>keys(),返回一个新的迭代对象，其中包含 Map 对象中所有的键</li>
<li>values(),返回一个新的迭代对象，其中包含 Map 对象中所有的值</li>
<li>entries(),返回一个新的迭代对象，其为一个包含 Map 对象中所有键值对的 [key, value] 数组</li>
<li>clear 清空 Map，返回 undefined</li>
</ol>
<p>迭代 Map</p>
<ol>
<li>使用 for...of 循环</li>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">const</span> <span class="token punctuation">[</span>key<span class="token punctuation">,</span> value<span class="token punctuation">]</span> <span class="token keyword">of</span> map<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<p>在 JavaScript 中，Map 和 Object 看起来都是用键值对来存储数据，不同处：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//对象的构建方式</span>
...
<li>在 Object 中， key 必须是简单数据类型（整数，字符串或者是 symbol）</li>
<li>在 Map 中则可以是 JavaScript 支持的所有数据类型，也就是说可以用一个 Object 来当做一个 Map 元素的 key</li>
<li>Map 元素的顺序遵循插入的顺序，而 Object 的则没有这一特性</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="weakmap" tabindex="-1"><a class="header-anchor" href="#weakmap" aria-hidden="true">#</a> WeakMap</h2>
<p>与 map 的区别：</p>
<ol>
<li>WeakMap 的 key 只能使用对象，不接受其他的类型作为 key</li>
<li>WeakMap 的 key 对对象的引用是弱引用，如果没有其他引用引用这个对象，那么 GC 可以回收该对象</li>
<li>WeakMap 不能遍历</li>
</ol>
</div></template>
