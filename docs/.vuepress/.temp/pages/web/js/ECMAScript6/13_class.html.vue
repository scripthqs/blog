<template><div><h1 id="class" tabindex="-1"><a class="header-anchor" href="#class" aria-hidden="true">#</a> class</h1>
<p>在 ES6 中，可以使用 class 来定义类，可以使用两种方法：</p>
<ol>
<li>类声明式</li>
<li>类表达式</li>
</ol>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="constructor-构造函数" tabindex="-1"><a class="header-anchor" href="#constructor-构造函数" aria-hidden="true">#</a> constructor 构造函数</h2>
<p>希望在创建对象的时候给类传递一个参数，需要</p>
<ul>
<li>每个类都可以有一个自己的构造函数（方法），这个方法叫做 constructor</li>
<li>当通过 new 操作符时，操作一个类就会调用这个类的构造函数(constructor)</li>
<li>每个类只能有一个构造函数(constructor)，如果包含多个 constructor 会抛出异常</li>
</ul>
<p>通过 new 关键字操作类时，会调用 constructor 函数，并且会执行一下操作：</p>
<ol>
<li>在内存中创建一个新的空对象</li>
<li>对象内部的<code v-pre>[[prototype]]</code>属性会被赋值为该类的 prototype 属性</li>
<li>构造函数内部的 this，会指向创建出来的新对象</li>
<li>执行构造函数的内部代码（函数体代码）</li>
<li>如果构造函数没有返回非空对象，则返回创建出来的新对象；</li>
</ol>
<h2 id="类的实例方法" tabindex="-1"><a class="header-anchor" href="#类的实例方法" aria-hidden="true">#</a> 类的实例方法</h2>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="static-类的静态方法" tabindex="-1"><a class="header-anchor" href="#static-类的静态方法" aria-hidden="true">#</a> static 类的静态方法</h2>
<p>静态方法用于直接使用类来执行的方法，不需要类的实例，使用 static 关键字定义</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="extend-继承" tabindex="-1"><a class="header-anchor" href="#extend-继承" aria-hidden="true">#</a> extend 继承</h2>
<p>用 extends 关键字，可以方便的实现继承</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="super-关键字" tabindex="-1"><a class="header-anchor" href="#super-关键字" aria-hidden="true">#</a> super 关键字</h2>
<p>在子（派生）类的构造函数中使用 this 或者返回默认对象之前，必须先通过 super 调用父类的构造函数</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 子类的构造函数、实例方法、静态方法</span>
