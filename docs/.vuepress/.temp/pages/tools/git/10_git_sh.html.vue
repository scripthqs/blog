<template><div><h1 id="git-一键提交" tabindex="-1"><a class="header-anchor" href="#git-一键提交" aria-hidden="true">#</a> git 一键提交</h1>
<p>使用 Git 的过程中，有时候需要经常和频繁的提交操作，每次都要 add，commit，pull，push</p>
<h2 id="方法" tabindex="-1"><a class="header-anchor" href="#方法" aria-hidden="true">#</a> 方法</h2>
<p>新建一个 .sh 文件，比如 git.sh</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">now</span><span class="token operator">=</span><span class="token variable"><span class="token variable">$(</span><span class="token function">date</span> <span class="token string">"+%Y-%m-%d %H:%M:%S"</span><span class="token variable">)</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="注意" tabindex="-1"><a class="header-anchor" href="#注意" aria-hidden="true">#</a> 注意</h2>
<ul>
<li>
<p>在文件夹下复制的路径是\，应该改成正斜杠/</p>
</li>
<li>
<p>如何连命令窗口都不想保留，那就把最后那个 read 拿掉就好了。</p>
</li>
<li>
<p>如果想每次输入 commit 文字，那就把 now 这个变量设置成 read 变量</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token builtin class-name">read</span> <span class="token parameter variable">-p</span>  <span class="token string">"请输入提交信息："</span> msg
...
<h2 id="我的-git-文件" tabindex="-1"><a class="header-anchor" href="#我的-git-文件" aria-hidden="true">#</a> 我的 git 文件</h2>
