<template><div><h1 id="react-高阶组件" tabindex="-1"><a class="header-anchor" href="#react-高阶组件" aria-hidden="true">#</a> React 高阶组件</h1>
<p>高阶组件是参数为组件，返回值为新组件的函数。</p>
<ul>
<li>高阶组件本质是一个函数</li>
<li>这个函数的参数是组件，返回值也是一个组件</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 定义一个高阶组件</span>
...
<ul>
<li>ES6 中，类表达式中的类名可以省略</li>
<li>组件名称可以通过 displayName 来修改</li>
</ul>
<h2 id="增强-props" tabindex="-1"><a class="header-anchor" href="#增强-props" aria-hidden="true">#</a> 增强 props</h2>
<p>给一些需要特殊数据的组件, 注入 props</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> PureComponent <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"react"</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="共享-context" tabindex="-1"><a class="header-anchor" href="#共享-context" aria-hidden="true">#</a> 共享 Context</h2>
<p>利用高阶组件共享 Context</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// context/theme_context.js</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="判断鉴权" tabindex="-1"><a class="header-anchor" href="#判断鉴权" aria-hidden="true">#</a> 判断鉴权</h2>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// hoc/loginAuth.js</span>
...
<li><code v-pre>this.forceUpdate()</code>可以强制渲染 render 函数，但是不推荐</li>
<li>尽量通过修改 state 来渲染 render 函数</li>
</ul>
<h2 id="劫持生命周期" tabindex="-1"><a class="header-anchor" href="#劫持生命周期" aria-hidden="true">#</a> 劫持生命周期</h2>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// hoc/log_render_time.js</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="高阶组件的不足" tabindex="-1"><a class="header-anchor" href="#高阶组件的不足" aria-hidden="true">#</a> 高阶组件的不足</h2>
<p>高阶组件可以对 React 代码进行复用，早期 React 是通过 mixin，但是现在已经不推荐</p>
<ul>
<li>Mixin 可能会相互依赖，不利于维护</li>
<li>不同的 Mixin 方法可能会有冲突</li>
</ul>
<p>HOC 也有一些缺陷，类组件使用还是挺多</p>
<ul>
<li>HOC 需要在原组件进行包裹或者嵌套，大量的 HOC 也不利于维护</li>
<li>HOC 可以劫持 props，也可能造成冲突</li>
</ul>
<p>目前最好的方案是使用 Hooks 来解决这些问题</p>
<h2 id="memo-和-forwardref" tabindex="-1"><a class="header-anchor" href="#memo-和-forwardref" aria-hidden="true">#</a> memo 和 forwardRef</h2>
<ul>
<li>memo：函数式组件常用的 memo，本质就是一个高阶组件，劫持 props 判断是否重新渲染</li>
<li>forwardRef：函数式组件常用的 forwardRef，也是一个高阶组件，用来获取组件的 ref</li>
</ul>
</div></template>
