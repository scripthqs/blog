<template><div><h1 id="react-setstate" tabindex="-1"><a class="header-anchor" href="#react-setstate" aria-hidden="true">#</a> React setState</h1>
<p>开发中并不能直接通过修改 state 的值让界面发生更新</p>
<ul>
<li>修改 state 后，希望 React 根据最新的 state 来重新渲染界面，这是直接修改 state 会让 React 不知道数据何时修改</li>
<li>React 没有类似 Vue2 的 Object.defineProperty 或者 Vue3 的 proxy 的方式监听数据的变化</li>
<li>React 必须通过 setState 来告知 React 数据已经发生了变化</li>
</ul>
<p>setState 方法是从 Component 中继承来的</p>
<h2 id="setstate-的使用" tabindex="-1"><a class="header-anchor" href="#setstate-的使用" aria-hidden="true">#</a> setState 的使用</h2>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 1.setState的基本使用</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">.</span>state<span class="token punctuation">.</span>message<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="setstate-异步更新" tabindex="-1"><a class="header-anchor" href="#setstate-异步更新" aria-hidden="true">#</a> setState 异步更新</h2>
<p>setState 的更新是异步的，并不能在执行完 setState 之后马上拿到最新的 state 结果</p>
<ol>
<li>setState 设计成异步，可以显著提升性能
<ul>
<li>如果每次调用 setState 都会进行一次更新，那么 render 函数会被频繁调用，界面重新渲染</li>
<li>最好的方法应该是获取多个更新后，批量更新</li>
</ul>
</li>
...
<li>
<p>setState 的回调</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">setState</span><span class="token punctuation">(</span><span class="token punctuation">{</span> <span class="token literal-property property">message</span><span class="token operator">:</span> <span class="token string">"hello state3"</span> <span class="token punctuation">}</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
...
<li>
<p>生命周期函数</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token function">componentDidUpdate</span><span class="token punctuation">(</span><span class="token parameter">prevProps<span class="token punctuation">,</span> prevState<span class="token punctuation">,</span> snapshot</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<p>在 React18 之前时，setState 有可能不是异步的</p>
<ul>
<li>在组件生命周期或 React 合成事件中，setState 是异步的</li>
<li>在 setTimeout 或原生 DOM 事件中，setState 是同步的</li>
</ul>
<p>在 React18 之后，默认所有的操作都放到了批处理中（异步处理）</p>
<ul>
<li>如果希望拿到同步的操作，需要执行特殊的 flushSync 操作</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> flushSync <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"react-dom"</span><span class="token punctuation">;</span>
