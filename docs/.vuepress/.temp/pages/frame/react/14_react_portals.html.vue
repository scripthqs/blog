<template><div><h1 id="react-的-portals" tabindex="-1"><a class="header-anchor" href="#react-的-portals" aria-hidden="true">#</a> React 的 Portals</h1>
<p>某些情况下，希望渲染的内容独立于父组件，甚至独立于当前挂载到的 DOM 元素中，默认都是挂载到 id 为 root 的 DOM 元素上。Portal 提供了一种将子节点渲染到存在父组件外的 DOM 节点。类似 Vue3 的 teleport。</p>
<h2 id="createportal" tabindex="-1"><a class="header-anchor" href="#createportal" aria-hidden="true">#</a> createPortal</h2>
<ul>
<li>第一个参数：任何可渲染的 React 子元素，例如一个元素，字符串或 fragment</li>
<li>第二个参数：是一个 DOM 元素</li>
</ul>
