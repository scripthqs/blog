<template><div><h1 id="react-的-strictmode" tabindex="-1"><a class="header-anchor" href="#react-的-strictmode" aria-hidden="true">#</a> React 的 StrictMode</h1>
<p>StrictMode 用来开启严格模式</p>
<ul>
<li>StrictMode 是一个组件，和 Fragment 一样，不会渲染任何 UI</li>
<li>可以给后代元素触发额外的检查和警告</li>
<li>严格模式检测仅在开发模式下运行，不会影响构建</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> React<span class="token punctuation">,</span> <span class="token punctuation">{</span> PureComponent<span class="token punctuation">,</span> StrictMode <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"react"</span><span class="token punctuation">;</span>
<span class="token comment">// import { findDOMNode } from "react-dom"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>严格模式主要是检测什么：</p>
<ul>
<li>识别不安全的生命周期</li>
<li>使用过时的 ref API</li>
<li>严格模式下，constructor 等生命周期会执行 2 次，生产环境还是 1 次</li>
<li>总的来说就是检测过时的方法</li>
</ul>
</div></template>
