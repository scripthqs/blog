<template><div><h1 id="react-hooks" tabindex="-1"><a class="header-anchor" href="#react-hooks" aria-hidden="true">#</a> React Hooks</h1>
<p>Hook 是 React 16.8 的新增特性，可以在不编写 class 的情况下使用 state 以及其他 React 特性(比如生命周期)。</p>
<p>class 组件的优势：</p>
<ul>
<li>可以定义自己的状态</li>
<li>有自己的生命周期</li>
<li>在状态改变时会重新执行 render 函数</li>
</ul>
<p>所以在 hook 出现之前，通常是使用 class 组件</p>
<p>class 组件的不足：</p>
<ul>
<li>class 组件会变得复杂</li>
<li>componentDidMount 会包含大量逻辑代码，包括网络请求，事件监听</li>
<li>难以拆分</li>
<li>this 的指向和 class 可能会有点难</li>
</ul>
<p>所以，hook 的出现解决了这些问题</p>
<ul>
<li>不用写 class，替代之前 class</li>
<li>向下兼容，可以渐进式使用，不影响之前的内容</li>
<li>hook 只能在函数式组件中使用</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> React<span class="token punctuation">,</span> <span class="token punctuation">{</span> memo<span class="token punctuation">,</span> useState <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"react"</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>useState 来自 react，从 react 导入，它是一个 hook。</p>
<p>Hook 是 js 函数，可以帮助我们钩入(hook into) React State 以及生命周期等特性。类似 useState,useEffect 函数叫 hook，hooks 是这一类函数的总称。</p>
<ul>
<li>只能在函数最外层调用 Hook。不要在循环、条件判断或子函数中调用</li>
<li>只能在 React 的函数组件中调用 Hook。不要在其他 js 函数中调用</li>
<li>在自定义 hooks 中，可以使用 hooks，自定义 hook 必须使用 use 开头</li>
</ul>
<h2 id="usestate" tabindex="-1"><a class="header-anchor" href="#usestate" aria-hidden="true">#</a> useState</h2>
<p>useState 可以定义个 state 变量，和 class 里面的 this.state 提供的功能完全一样。</p>
<ul>
<li>参数：接受唯一一个参数，用作初始化值，如果不设置就是 undefined</li>
<li>返回值：数组，包含两个元素，配合数组的解构，完成赋值会非常方便
<ul>
<li>当前状态的值</li>
<li>设置状态值的函数</li>
</ul>
...
<p>Effect Hook 可以用来完成一些类似于 class 中生命周期的功能。</p>
<ul>
<li>类似于网络请求、手动更新 DOM、一些事件的监听，都是 React 更新 DOM 的一些副作用（Side Effects）</li>
<li>对于完成这些功能的 Hook 被称之为 Effect Hook</li>
</ul>
...
<li>通过 useEffect 的 Hook，告诉 React 需要在渲染后执行某些操作</li>
<li>useEffect 需要传入一个回调函数，在 React 执行完更新 DOM 操作之后，就会回调这个函数</li>
<li>默认情况下，无论是第一次渲染之后，还是每次更新之后，都会执行这个回调函数</li>
</ul>
<h3 id="清除-effect" tabindex="-1"><a class="header-anchor" href="#清除-effect" aria-hidden="true">#</a> 清除 Effect</h3>
<p>在 class 组件中，有些事件需要在 componentWillUnmount 中进行清除</p>
<ul>
<li>useEffect 传入的回调函数 A 本身可以有一个返回值，这个返回值是另外一个回调函数 B</li>
<li>effect 可选的清除机制。每个 effect 都可以返回一个清除函数</li>
<li>可以将添加和移除订阅的逻辑放在一起</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> React<span class="token punctuation">,</span> <span class="token punctuation">{</span> memo<span class="token punctuation">,</span> useState<span class="token punctuation">,</span> useEffect <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"react"</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="分离-useeffect" tabindex="-1"><a class="header-anchor" href="#分离-useeffect" aria-hidden="true">#</a> 分离 useEffect</h3>
<p>使用 Effect Hook，我们可以根据代码的用途将它们分离到不同的 useEffect 中</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="性能优化-effect" tabindex="-1"><a class="header-anchor" href="#性能优化-effect" aria-hidden="true">#</a> 性能优化 effect</h3>
<p>默认情况下，useEffect 的回调函数会在每次渲染时都重新执行</p>
<ul>
<li>某些代码我们只是希望执行一次即可，类似于 componentDidMount 和 componentWillUnmount 中完成的事情。(比如网
络请求、订阅和取消订阅)</li>
</ul>
<p>useEffect 实际上有两个参数</p>
<ol>
<li>执行的回调函数</li>
<li>该 useEffect 在哪些 state 发生变化时，才重新执行(受谁的影响)</li>
</ol>
<p>如果一个函数我们不希望依赖任何的内容时，也可以传入一个空的数组 <code v-pre>[]</code></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> React<span class="token punctuation">,</span> <span class="token punctuation">{</span> memo<span class="token punctuation">,</span> useEffect <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"react"</span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> useState <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"react"</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="usecontext" tabindex="-1"><a class="header-anchor" href="#usecontext" aria-hidden="true">#</a> useContext</h2>
<p>在之前的开发中，要在组件中使用共享的 Context 有两种方式</p>
<ul>
<li>类组件可以通过类名.contextType = MyContext 方式，在类中获取 context</li>
<li>多个 Context 或者函数式组件中通过 MyContext.Consumer 共享 context</li>
</ul>
...
<p>当需要将一个函数传递给子组件时, 最好使用 useCallback 进行优化, 将优化之后的函数, 传递给子组件</p>
<ul>
<li>useCallback 会返回一个函数的 memoized（记忆的） 值</li>
...
<p>useRef 返回一个 ref 对象，返回的 ref 对象在组件的整个生命周期保持不变。用法：</p>
<ul>
<li>引入 DOM（或者组件，但是需要是 class 组件）元素</li>
<li>保存一个数据，这个对象在整个生命周期中可以保存不变</li>
</ul>
<h2 id="useimperativehandle" tabindex="-1"><a class="header-anchor" href="#useimperativehandle" aria-hidden="true">#</a> useImperativeHandle</h2>
<p>对于 ref 和 forwardRef 结合使用</p>
<ul>
<li>通过 forwardRef 可以将 ref 转发到子组件</li>
<li>子组件拿到父组件中创建的 ref，绑定到自己的某一个元素中</li>
</ul>
<p>这样的做法将子组件的 DOM 直接暴露给了父组件，会有一些问题</p>
<ul>
<li>直接暴露给父组件不可控</li>
<li>父组件可以拿到 DOM 后进行任意的操作</li>
</ul>
<p>useImperativeHandle 可以只暴露固定的操作</p>
<h2 id="uselayouteffect" tabindex="-1"><a class="header-anchor" href="#uselayouteffect" aria-hidden="true">#</a> useLayoutEffect</h2>
<p>和 useEffect 非常的相似</p>
<ul>
<li>useEffect 会在渲染的内容更新到 DOM 上后执行，不会阻塞 DOM 的更新</li>
<li>useLayoutEffect 会在渲染的内容更新到 DOM 上之前执行，会阻塞 DOM 的更新</li>
</ul>
<p>希望在某些操作发生之后再更新 DOM，那么应该将这个操作放到 useLayoutEffect。</p>
<h2 id="redux-hooks" tabindex="-1"><a class="header-anchor" href="#redux-hooks" aria-hidden="true">#</a> redux hooks</h2>
<p>为了让组件和 redux 结合起来，需要使用 react-redux 的 connect</p>
<ul>
<li>这种方式必须使用高阶函数结合返回的高阶组件</li>
<li>必须编写 mapStateToProps 和 mapDispatchToProps 映射函数</li>
</ul>
<p>使用 hook 的方式，不需要编写 connect 以及对应的映射函数</p>
<h3 id="useselector" tabindex="-1"><a class="header-anchor" href="#useselector" aria-hidden="true">#</a> useSelector</h3>
<p>useSelector 将 state 映射到组件</p>
<ul>
<li>参数 1：将 state 映射到需要的数据中</li>
<li>参数 2：可以进行比较来决定是否重新渲染组件</li>
</ul>
<p>useSelector 会默认比较返回的两个对象是否相等，必须返回两个完全相等的对象才不重新渲染</p>
<h3 id="usedispatch" tabindex="-1"><a class="header-anchor" href="#usedispatch" aria-hidden="true">#</a> useDispatch</h3>
<p>useDispatch 直接获取 dispatch 函数，之后在组件中直接使用即可</p>
<h2 id="自定义-hooks" tabindex="-1"><a class="header-anchor" href="#自定义-hooks" aria-hidden="true">#</a> 自定义 hooks</h2>
<p>自定义 hook 本质式函数代码逻辑的抽取，不是只有 React 可以写，Vue3 也可以写 hooks 了</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//打印生命周期</span>
