<template><div><h1 id="vue3-工程结构" tabindex="-1"><a class="header-anchor" href="#vue3-工程结构" aria-hidden="true">#</a> Vue3 工程结构</h1>
<h2 id="main-js" tabindex="-1"><a class="header-anchor" href="#main-js" aria-hidden="true">#</a> main.js</h2>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//引入的不再是Vue构造函数，引入的是名为createApp工厂函数</span>
...
<span class="token comment">//创建应用实例对象</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="app-vue" tabindex="-1"><a class="header-anchor" href="#app-vue" aria-hidden="true">#</a> App.vue</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Vue3 组件中的 template <strong>可以没有根标签</strong>。</p>
<h3 id="template-标签" tabindex="-1"><a class="header-anchor" href="#template-标签" aria-hidden="true">#</a> template 标签</h3>
<p>template 标签并不是 Vue 中独有的，是属于 HTML 中的内容，在 MDN 中的描述 <a href="https://developer.mozilla.org/zh-CN/docs/Web/HTML/Element/template" target="_blank" rel="noopener noreferrer">template<ExternalLinkIcon/></a>。</p>
<ul>
<li>解析器在加载页面时会处理<code v-pre>&lt;template&gt;</code>元素的内容，但这样做只是为了确保这些内容有效；但元素内容不会被渲染</li>
<li>template 元素是一种用于保存客户端内容的机制，该内容再加载页面时不会被呈现，但随后可以在运行时使用 JavaScript 实例化</li>
</ul>
<h2 id="vue-开发者工具" tabindex="-1"><a class="header-anchor" href="#vue-开发者工具" aria-hidden="true">#</a> Vue 开发者工具</h2>
<p>Vue3 项目不能再使用 Vue2 的开发者工具，需要重新下载，并且禁用之前的开发者工具。</p>
<h2 id="vue3-模板语法" tabindex="-1"><a class="header-anchor" href="#vue3-模板语法" aria-hidden="true">#</a> Vue3 模板语法</h2>
<p>React 的开发模式：</p>
<ul>
<li>React 使用的 jsx，所以对应的代码都是编写的类似于 js 的一种语法；</li>
<li>之后通过 Babel 将 jsx 编译成 React.createElement 函数调用；</li>
</ul>
<p>Vue3 也支持 jsx 的开发模式：</p>
<ul>
<li>大多数情况下，使用<strong>基于 HTML 的模板语法</strong>，即<code v-pre>{{}}</code>语法</li>
<li>在模板中，允许开发者以声明式的方式将 DOM 和底层组件实例的数据绑定在一起；</li>
<li>在底层的实现中，Vue 将模板编译成虚拟 DOM 渲染函数</li>
</ul>
<h2 id="vue3-其他改变" tabindex="-1"><a class="header-anchor" href="#vue3-其他改变" aria-hidden="true">#</a> Vue3 其他改变</h2>
<h3 id="全局-api-的转移" tabindex="-1"><a class="header-anchor" href="#全局-api-的转移" aria-hidden="true">#</a> 全局 API 的转移</h3>
<ul>
<li>
...
<h2 id="其他改变" tabindex="-1"><a class="header-anchor" href="#其他改变" aria-hidden="true">#</a> 其他改变</h2>
<ul>
<li>
...
<li>
<p><strong>移除</strong>keyCode 作为 v-on 的修饰符，同时也不再支持<code v-pre>config.keyCodes</code></p>
</li>
<li>
<p><strong>移除</strong><code v-pre>v-on.native</code>修饰符</p>
<ul>
<li>
<p>父组件中绑定事件</p>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>my-component</span> <span class="token attr-name"><span class="token namespace">v-on:</span>close</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>handleComponentEvent<span class="token punctuation">"</span></span> <span class="token attr-name"><span class="token namespace">v-on:</span>click</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>handleNativeClickEvent<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
