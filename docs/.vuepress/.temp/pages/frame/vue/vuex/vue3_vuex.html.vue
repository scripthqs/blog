<template><div><h1 id="vue3-vuex" tabindex="-1"><a class="header-anchor" href="#vue3-vuex" aria-hidden="true">#</a> Vue3 Vuex</h1>
<ol>
<li>安装 vuex
<ul>
<li>npm install vuex</li>
</ul>
</li>
<li>创建 store
<ul>
...
<li>app.use(store)</li>
<li>template -&gt; <code v-pre>$store.state.counter</code></li>
</ol>
<p>通过 createStore 创建一个 store 实例</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span>createStore<span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"vuex"</span>
