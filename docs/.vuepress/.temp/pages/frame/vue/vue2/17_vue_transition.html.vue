<template><div><h1 id="vue-封装的过渡与动画" tabindex="-1"><a class="header-anchor" href="#vue-封装的过渡与动画" aria-hidden="true">#</a> Vue 封装的过渡与动画</h1>
...
<p>使用<code v-pre>&lt;transition&gt;</code>包裹要过度的元素，并配置 name 属性</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span>transition name<span class="token operator">=</span><span class="token string">"hello"</span><span class="token operator">></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>若有多个元素需要过渡，则需要使用：<code v-pre>&lt;transition-group&gt;</code>，且每个元素都要指定<code v-pre>key</code>值。</p>
</div></template>
