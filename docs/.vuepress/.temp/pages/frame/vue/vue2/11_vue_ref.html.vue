<template><div><h1 id="ref-引用" tabindex="-1"><a class="header-anchor" href="#ref-引用" aria-hidden="true">#</a> ref 引用</h1>
<p>ref 用来辅助开发者在<strong>不依赖于 jQuery 的情况下</strong>，获取 DOM 元素或组件的引用。</p>
<p>每个 vue 的组件实例上，都包含一个 <strong><code v-pre>$refs 对象</code></strong>，里面存储着对应的 DOM 元素或组件的引用。默认情况下， <strong>组件的 <code v-pre>$refs</code> 指向一个空对象</strong></p>
<h2 id="使用-ref-引用-dom-元素" tabindex="-1"><a class="header-anchor" href="#使用-ref-引用-dom-元素" aria-hidden="true">#</a> 使用 ref 引用 DOM 元素</h2>
<p>使用 ref 引用 DOM 元素</p>
...
<span class="token literal-property property">methods</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="使用-ref-引用组件实例" tabindex="-1"><a class="header-anchor" href="#使用-ref-引用组件实例" aria-hidden="true">#</a> 使用 ref 引用组件实例</h2>
<p>给组件的标签上添加 ref 属性，父组件就可以使用子组件的方法和值，</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="使用-ref-属性实现组件通信" tabindex="-1"><a class="header-anchor" href="#使用-ref-属性实现组件通信" aria-hidden="true">#</a> 使用 ref 属性实现组件通信</h2>
<p>ref 属性用在子组件上，它的引用就指向子组件的实例。可以通过实例访问组件的数据和方法。</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="this-nexttick-cb" tabindex="-1"><a class="header-anchor" href="#this-nexttick-cb" aria-hidden="true">#</a> <code v-pre>this.$nextTick(cb)</code></h2>
<p>通过布尔值 inputVisible 来控制组件中的文本框与按钮的按需切换</p>
<p>当文本框展示出来之后，如果希望它立即获得焦点，则可以为其添加 ref 引用，并调用原生 DOM 对象的 .focus() 方法</p>
<p>组件的 <code v-pre>$nextTick(cb)</code> 方法，会把 cb 回调推迟到下一个 DOM 更新周期之后执行。通俗的理解是：<strong>等组件的 DOM 更新完成之后，再执行 cb 回调函数。从而能保证 cb 回调函数可以操作到最新的 DOM 元素</strong></p>
