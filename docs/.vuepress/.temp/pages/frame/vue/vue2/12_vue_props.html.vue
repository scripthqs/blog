<template><div><h1 id="组件的通信" tabindex="-1"><a class="header-anchor" href="#组件的通信" aria-hidden="true">#</a> 组件的通信</h1>
<h2 id="组件之间的关系" tabindex="-1"><a class="header-anchor" href="#组件之间的关系" aria-hidden="true">#</a> 组件之间的关系</h2>
<p>在项目开发中，组件之间的最常见的关系分为如下两种：</p>
<ol>
<li>父子关系</li>
<li>兄弟关系</li>
</ol>
<h2 id="组件的数据共享" tabindex="-1"><a class="header-anchor" href="#组件的数据共享" aria-hidden="true">#</a> 组件的数据共享</h2>
<p>父子组件之间的数据共享分为：</p>
<ul>
<li>父组件向子组件传递数据</li>
<li>子组件向父组件传递数据</li>
</ul>
<h2 id="父子组件数据传递" tabindex="-1"><a class="header-anchor" href="#父子组件数据传递" aria-hidden="true">#</a> 父子组件数据传递</h2>
<p>父组件向子组件共享数据使用<strong>自定义属性 props</strong>。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>  <span class="token comment">//父组件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意：不用<code v-pre>v-bind</code>传递时，相当于直接传递字符串'message'，</p>
<p>用<code v-pre>:</code>才能把'hello vue'传递给子组件
子组件向父组件共享数据使用<strong>自定义事件<code v-pre>$emit</code></strong></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>  <span class="token comment">//子组件</span>
  <span class="token function">data</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    <span class="token keyword">return</span> <span class="token punctuation">{</span>
  ...
  <span class="token literal-property property">methods</span><span class="token operator">:</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue-的组件通信总结" tabindex="-1"><a class="header-anchor" href="#vue-的组件通信总结" aria-hidden="true">#</a> Vue 的组件通信总结</h2>
<h3 id="_1-props-emit-常用" tabindex="-1"><a class="header-anchor" href="#_1-props-emit-常用" aria-hidden="true">#</a> 1.<code v-pre>props/$emit</code>(常用)</h3>
...
<h3 id="_2-emit-on-各种组件关系" tabindex="-1"><a class="header-anchor" href="#_2-emit-on-各种组件关系" aria-hidden="true">#</a> 2.<code v-pre>$emit/$on</code>(各种组件关系)</h3>
<p>eventBus 事件总线<code v-pre>$emit/$on</code>适用于<strong>各种组件</strong>之间传递数据。步骤：</p>
<ol>
<li>新建 event-bus.js 模块文件，向外共享一个 Vue 实例对象</li>
<li>在数据的发送方，使用自定义事件，调用<code v-pre>bus.$emit('事件名称',发送的数据)</code></li>
<li>在数据的接收方，组测自定义事件，<code v-pre>bus.$on('自定义事件名称',事件处理函数)</code></li>
</ol>
...
<ol>
<li>
<p>在 Vue 的原型上添加一个<code v-pre>$bus</code> 的属性让其等于一个新的 Vue 实例</p>
</li>
<li>
<p>发射全局监听事件，和常规<code v-pre>$emit</code> 一样也可以传递参数</p>
</li>
<li>
<p>监听全局事件</p>
...
<h3 id="_3-ref-refs-常用" tabindex="-1"><a class="header-anchor" href="#_3-ref-refs-常用" aria-hidden="true">#</a> 3.<code v-pre>ref/$refs</code>(常用)</h3>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//在子组件中，$parent是一个对象 this.$parent.msg</span>
<span class="token comment">//在父组件中，$children是一个数组 this.$children[0].msg</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-attrs-listeners" tabindex="-1"><a class="header-anchor" href="#_5-attrs-listeners" aria-hidden="true">#</a> 5.<code v-pre>$attrs/$listeners</code></h3>
<p><code v-pre>$attrs和$listeners</code>使用于<strong>父子、隔代组件之间的通信</strong>。</p>
<ul>
<li><code v-pre>$attrs</code>属性继承了父组件的所有属性（除了 props 传递的属性,class,style）</li>
<li><code v-pre>$listeners</code>是一个对象，包含了父组件的各种事件方法。可以使用<code v-pre>v-bind='$attr'</code>继续向子组件中传递属性。</li>
</ul>
<h3 id="_6-provide-inject" tabindex="-1"><a class="header-anchor" href="#_6-provide-inject" aria-hidden="true">#</a> 6.<code v-pre>provide/inject</code></h3>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//在父组件中，provide书写方式和data一样</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意：provide 提供的属性有点像一个全局的变量，有可能造成变量的污染，而且依赖注入提供的属性是<strong>非响应式</strong>的。</p>
<h3 id="_7-vuex-常用" tabindex="-1"><a class="header-anchor" href="#_7-vuex-常用" aria-hidden="true">#</a> 7.vuex(常用)</h3>
<p>当数据比较复杂时，可以使用 vuex，将一些公共的数据抽离出来，作为全局变量进行管理，其他组件可以对这个公共数据进行读写操作。</p>
<h3 id="_8-离线存储-常用" tabindex="-1"><a class="header-anchor" href="#_8-离线存储-常用" aria-hidden="true">#</a> 8.离线存储(常用)</h3>
<p>可以使用浏览器的离线存储机制</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//组件a</span>
<span class="token function">created</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
