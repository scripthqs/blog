<template><div><h1 id="_10-手写-promise" tabindex="-1"><a class="header-anchor" href="#_10-手写-promise" aria-hidden="true">#</a> 10 手写 Promise</h1>
<h2 id="_10-1-api-相关" tabindex="-1"><a class="header-anchor" href="#_10-1-api-相关" aria-hidden="true">#</a> 10.1 API 相关</h2>
<h2 id="_10-2-整体实现流程" tabindex="-1"><a class="header-anchor" href="#_10-2-整体实现流程" aria-hidden="true">#</a> 10.2 整体实现流程</h2>
<ol>
<li>定义整体结构</li>
<li>Promise 构造函数的实现</li>
...
<h2 id="_10-3-编码实现" tabindex="-1"><a class="header-anchor" href="#_10-3-编码实现" aria-hidden="true">#</a> 10.3 编码实现</h2>
<ul>
<li><code v-pre>src/promise/index.js</code></li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token constant">PENDING</span> <span class="token operator">=</span> <span class="token string">"pending"</span><span class="token punctuation">;</span> <span class="token comment">// 初始未确定的状态</span>
