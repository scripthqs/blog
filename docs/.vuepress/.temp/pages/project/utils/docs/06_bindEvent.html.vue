<template><div><h1 id="_6-手写-dom-事件监听-带委托" tabindex="-1"><a class="header-anchor" href="#_6-手写-dom-事件监听-带委托" aria-hidden="true">#</a> 6 手写 DOM 事件监听(带委托)</h1>
<h2 id="_6-1-理解事件冒泡与事件委托" tabindex="-1"><a class="header-anchor" href="#_6-1-理解事件冒泡与事件委托" aria-hidden="true">#</a> 6.1 理解事件冒泡与事件委托</h2>
<ul>
<li>
<p>事件冒泡的流程</p>
<ul>
...
<h2 id="_6-2-api-相关" tabindex="-1"><a class="header-anchor" href="#_6-2-api-相关" aria-hidden="true">#</a> 6.2 API 相关</h2>
<ul>
<li>语法：addEventListener(element, type, fn, selector)</li>
<li>说明：如果 selector 没有，直接给 element 绑定事件，如果 selector 有，将 selector 对应的多个元素的事件委托绑定给父元素 element</li>
</ul>
<h2 id="_6-3-编码实现" tabindex="-1"><a class="header-anchor" href="#_6-3-编码实现" aria-hidden="true">#</a> 6.3 编码实现</h2>
<ul>
<li>src/event-bind/index.js</li>
</ul>
...
<span class="token keyword">export</span> <span class="token keyword">function</span> <span class="token function">bindEvent</span><span class="token punctuation">(</span><span class="token parameter">ele<span class="token punctuation">,</span> type<span class="token punctuation">,</span> fn<span class="token punctuation">,</span> selector</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-3-测试" tabindex="-1"><a class="header-anchor" href="#_6-3-测试" aria-hidden="true">#</a> 6.3.测试</h2>
