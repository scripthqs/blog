<template><div><h1 id="vue3-typescript-后台管理系统" tabindex="-1"><a class="header-anchor" href="#vue3-typescript-后台管理系统" aria-hidden="true">#</a> Vue3 + TypeScript 后台管理系统</h1>
...
<p>两种方式：</p>
<ol>
<li>使用 Vue CLI，基于 Webpack，命令<code v-pre>vue create</code></li>
<li>create Vue，基于 vite 工具，命令<code v-pre>npm init vue@latest</code></li>
</ol>
<p>注意：第二种方式需要 node 版本 16 及以上</p>
<p><img src="https://raw.githubusercontent.com/scripthqs/assets/master/vue_create.png" alt="vue"></p>
<h2 id="默认文件" tabindex="-1"><a class="header-anchor" href="#默认文件" aria-hidden="true">#</a> 默认文件</h2>
<ul>
<li>
<p>.vscode 文件夹：<code v-pre>extensions.json</code> 推荐的 vscode 插件，如果没有，vscode 会读取这个文件并且自动安装。</p>
<ul>
<li>
...
<li>
<p>node_modules：node 相关依赖</p>
</li>
<li>
<p>public：在这文件夹中的资源打包时会原封不动的打包到 dist 文件夹</p>
<ul>
<li><code v-pre>favicon.ico</code>站点图标</li>
</ul>
</li>
<li>
<p>src：源代码文件夹</p>
...
<li>
<p>.eslintrc.cjs：代码规范</p>
</li>
<li>
<p>.gitignore：git 忽略文件</p>
</li>
<li>
<p>.prettierrc.json：代码格式化</p>
</li>
<li>
<p>env.d.ts：类型声明文件</p>
</li>
<li>
<p>package-lock.json：锁定依赖的版本</p>
</li>
<li>
<p>package.json：记录相关的依赖</p>
</li>
<li>
<p>readme.md：记录文档</p>
</li>
<li>
<p>tsconfig.json：ts 配置文件，这个文件生成后不建议修改（不一定）</p>
</li>
<li>
<p>tsconfig.config.json：tsconfig.json 引入的 ts 配置文件，其它单独的配置建议在这里面修改</p>
</li>
<li>
<p>vite.config.ts：配置 vite 的文件，等同于 cli 的 vue.config.ts，tsconfig.config.json 中引入了这个文件</p>
</li>
<li>
<p>index.html：入口文件</p>
</li>
...
<ul>
<li>这个文件默认配置是没有的，可以手动新建<code v-pre>.editorconfig</code>文件</li>
<li>VSCode 需要安装一个插件：EditorConfig for VS Code</li>
</ul>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code># http<span class="token operator">:</span><span class="token comment">//editorconfig.org</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="prettier" tabindex="-1"><a class="header-anchor" href="#prettier" aria-hidden="true">#</a> prettier</h3>
...
<ul>
<li>使用命令行新建项目的时候，默认可以选择 prettier</li>
</ul>
<p>如果没有选择，可以手动安装</p>
<ol>
<li>
<p>安装 prettier</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> prettier <span class="token parameter variable">-D</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p>配置.prettierrc 文件</p>
...
<li>
<p>创建<code v-pre>.prettierignore</code>忽略文件(也可以不用)</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>/dist<span class="token comment">/*
.local
.output.js
/node_modules/**
...
/public/*
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p>测试是否生效</p>
<ul>
<li>测试一：安装 prettier 插件，在代码中保存代码；</li>
<li>测试二：配置一次性修改的命令；</li>
</ul>
<p>在 package.json 中配置一个 scripts：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code> <span class="token property">"prettier"</span><span class="token operator">:</span> <span class="token string">"prettier --write ."</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p>vscode 中需要配置</p>
<ul>
<li>format on save</li>
<li>editor default format</li>
</ul>
</li>
</ol>
<h3 id="eslint" tabindex="-1"><a class="header-anchor" href="#eslint" aria-hidden="true">#</a> ESLint</h3>
<p>ESLint 可以检测不规范的代码</p>
<ul>
<li>创建项目的时候，选择了 ESLint，所以 Vue 会默认帮助我们配置需要的 ESLint 环境。</li>
</ul>
<p>如果没有选择 ESLint，可以手动安装</p>
<ol>
<li>
<p>项目中安装插件：（vue 在创建项目时，如果选择 prettier，那么这两个插件会自动安装）</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> eslint-plugin-prettier eslint-config-prettier <span class="token parameter variable">-D</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p>配置<code v-pre>.eslintrc.cjs</code>文件</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token comment">/* eslint-env node */</span>
...
<li>
<p>解决 eslint 和 prettier 冲突，在<code v-pre>.eslintrc.cjs</code>文件<code v-pre>extends</code>下添加<code v-pre>'plugin:prettier/recommended'</code></p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token comment">/* eslint-env node */</span>
require('@rushstack/eslint-patch/modern-module-resolution')
...
<li>
<p>vscode 配置完需要重启，修改了配置也需要重启（vscode 快捷键 ctrl + p 再输入<code v-pre>&gt;</code>)</p>
</li>
<li>
<p>配置 eslint 的规则， 在<code v-pre>.eslintrc.cjs</code>文件中新增<code v-pre>rules</code></p>
<p>复制（vscode 按住 alt）不想要的 eslint 不想要的提示，加入<code v-pre>rules</code>中<code v-pre>off</code></p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token comment">/* eslint-env node */</span>
...
<h3 id="重置-css" tabindex="-1"><a class="header-anchor" href="#重置-css" aria-hidden="true">#</a> 重置 css</h3>
<ol>
<li>
<p>安装 normalize.css 库</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> i normalize.css
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p>在 main.ts 中引入</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">import</span> <span class="token string">"normalize.css"</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
</ol>
<h3 id="prettier-配置" tabindex="-1"><a class="header-anchor" href="#prettier-配置" aria-hidden="true">#</a> prettier 配置</h3>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>  <span class="token comment">// "prettier.printWidth": 180, // 超过最大值换行</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="目录结构" tabindex="-1"><a class="header-anchor" href="#目录结构" aria-hidden="true">#</a> 目录结构</h2>
<h3 id="assets" tabindex="-1"><a class="header-anchor" href="#assets" aria-hidden="true">#</a> assets</h3>
<p>静态资源文件夹，存放 css 和 img 等</p>
<ul>
<li>
<p>在 css 文件夹下新建 index.less 文件</p>
</li>
<li>
<div class="language-less line-numbers-mode" data-ext="less"><pre v-pre class="language-less"><code><span class="token variable">@import</span> <span class="token string">"./reset.less"</span><span class="token punctuation">;</span>
...
<li>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">import</span> <span class="token string">"./assets/css/index.less"</span><span class="token punctuation">;</span> <span class="token comment">//在main.ts中引入index.less</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> i <span class="token function">less</span> <span class="token parameter variable">-D</span> //需要安装，不然报错，开发时依赖
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
</ul>
<h3 id="router" tabindex="-1"><a class="header-anchor" href="#router" aria-hidden="true">#</a> router</h3>
<ul>
<li>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> i vue-router
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p>新建 router 文件夹，配置路由</p>
</li>
</ul>
<h3 id="store" tabindex="-1"><a class="header-anchor" href="#store" aria-hidden="true">#</a> store</h3>
<p>使用 pinia 进行状态管理</p>
<ul>
<li>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> i pinia
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p>新建 store 文件夹</p>
</li>
...
<ul>
<li>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code>npm i axios
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p>新建 service 文件夹</p>
</li>
</ul>
<h3 id="结构图" tabindex="-1"><a class="header-anchor" href="#结构图" aria-hidden="true">#</a> 结构图</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>vue3_erp
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="环境变量" tabindex="-1"><a class="header-anchor" href="#环境变量" aria-hidden="true">#</a> 环境变量</h2>
<p>在开发中需要，在设置后端接口是通常需要区分开发环境（ development）和生产环境（production ），需要学习 vite 的环境变量</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token comment">// 1.手动注释，过分依赖人为修改</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="组件库" tabindex="-1"><a class="header-anchor" href="#组件库" aria-hidden="true">#</a> 组件库</h2>
<p>安装 element plus</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>npm install element<span class="token operator">-</span>plus <span class="token operator">--</span>save
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="全局引入-简洁方便" tabindex="-1"><a class="header-anchor" href="#全局引入-简洁方便" aria-hidden="true">#</a> 全局引入（简洁方便）</h3>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">import</span> ElementPlus <span class="token keyword">from</span> <span class="token string">"element-plus"</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="按需引入-优化" tabindex="-1"><a class="header-anchor" href="#按需引入-优化" aria-hidden="true">#</a> 按需引入（优化）</h3>
<blockquote>
<p>首先你需要安装<code v-pre>unplugin-vue-components</code>和 <code v-pre>unplugin-auto-import</code>这两款插件</p>
</blockquote>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code>npm install <span class="token operator">-</span><span class="token constant">D</span> unplugin<span class="token operator">-</span>vue<span class="token operator">-</span>components unplugin<span class="token operator">-</span>auto<span class="token operator">-</span><span class="token keyword">import</span>
<span class="token comment">//unplugin-auto-import //自动导入</span>
<span class="token comment">//unplugin-vue-components //识别用哪些组件</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>安装后，项目目录会多两个文件（自动声明，不需要手动修改）</p>
<ul>
<li>auto-imports.d.ts</li>
<li>components.d.ts</li>
</ul>
<p>安装后在 vite.config.ts 文件中配置</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在 tsconfig.json 中配置(<strong>ts 需要配置这一步</strong>)，此时就有了类型提示</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此时，vue 中写的 templeate 写的 el 组件，会在 components.d.ts 自动导入。</p>
<p>但是类似 ElMessage 这种写在 script 中的组件不会自动导入。（好像是导入了没有样式）</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//需要在vite.config.ts中配置</span>
...
<p><a href="https://github.com/vbenjs/vite-plugin-style-import/blob/main/README.md" target="_blank" rel="noopener noreferrer">https://github.com/vbenjs/vite-plugin-style-import/blob/main/README.md<ExternalLinkIcon/></a></p>
</blockquote>
<h2 id="cache-封装" tabindex="-1"><a class="header-anchor" href="#cache-封装" aria-hidden="true">#</a> cache 封装</h2>
<p>封装一个方法，存 localStorage 或者 sessionStorage</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Cache</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="登录流程" tabindex="-1"><a class="header-anchor" href="#登录流程" aria-hidden="true">#</a> 登录流程</h2>
<h3 id="判断-token" tabindex="-1"><a class="header-anchor" href="#判断-token" aria-hidden="true">#</a> 判断 token</h3>
<p>在路由配置中，<code v-pre>/</code>重定向到<code v-pre>main</code>主页面，但是可以判断有无 token，让路由到 login 页面</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">const</span> router <span class="token operator">=</span> <span class="token function">createRouter</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
...
router<span class="token punctuation">.</span><span class="token function">beforeEach</span><span class="token punctuation">(</span><span class="token punctuation">(</span>to<span class="token punctuation">,</span> from<span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="记住密码" tabindex="-1"><a class="header-anchor" href="#记住密码" aria-hidden="true">#</a> 记住密码</h3>
<p>登录的时候判断是否勾选记住密码</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">const</span> <span class="token function-variable function">loginAction</span> <span class="token operator">=</span> <span class="token punctuation">(</span>isKeep<span class="token operator">:</span> <span class="token builtin">boolean</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>经过我测试，发现上述方法有 bug，经排查是封装的 cache 方法有问题</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token function">setCache</span><span class="token punctuation">(</span>key<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">,</span> value<span class="token operator">:</span> <span class="token builtin">any</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">if</span><span class="token punctuation">(</span>value<span class="token punctuation">)</span><span class="token punctuation">{</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>storage<span class="token punctuation">.</span><span class="token function">setItem</span><span class="token punctuation">(</span>key<span class="token punctuation">,</span> <span class="token constant">JSON</span><span class="token punctuation">.</span><span class="token function">stringify</span><span class="token punctuation">(</span>value<span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
...
<span class="token function">setCache</span><span class="token punctuation">(</span>key<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">,</span> value<span class="token operator">:</span> <span class="token builtin">any</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">this</span><span class="token punctuation">.</span>storage<span class="token punctuation">.</span><span class="token function">setItem</span><span class="token punctuation">(</span>key<span class="token punctuation">,</span> <span class="token constant">JSON</span><span class="token punctuation">.</span><span class="token function">stringify</span><span class="token punctuation">(</span>value<span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以将 if(value)判断去掉，</p>
<ul>
<li>布尔值的 false，经过 JSON.stringify 将转成字符串的 false，</li>
<li>同样，字符串的 false 经过 JSON.parse 可以转成布尔值的 false</li>
</ul>
<h3 id="携带-token" tabindex="-1"><a class="header-anchor" href="#携带-token" aria-hidden="true">#</a> 携带 token</h3>
<p>通常来说，登录接口会返回一个 token，此外的大多数接口，基本都需要携带这个 token，不然会报 401。需要给其他接口添加一个 headers。</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code>apiRequest<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>开发中肯定不可能每个接口都写一次 header，而是在请求拦截时，将 header 放在里面</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code>interceptors<span class="token operator">:</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="角色权限" tabindex="-1"><a class="header-anchor" href="#角色权限" aria-hidden="true">#</a> 角色权限</h2>
<p>权限管理：根据登录用户的不同，呈现不同的后台管理系统的内容，具有不同的操作权限。</p>
<p>设计依据：基于后端数据库设计，RBAC(role based access control)基于角色的访问控制。</p>
<p>给用户分配不同的角色：</p>
<ul>
<li>超级管理员</li>
<li>管理员</li>
...
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token operator">&lt;</span>el<span class="token operator">-</span>icon<span class="token operator">></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="列表和树转换" tabindex="-1"><a class="header-anchor" href="#列表和树转换" aria-hidden="true">#</a> 列表和树转换</h2>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token comment">// 方式1：列表转换成树形结构;</span>
...
<p>对于权限管理，最简单的方式就是一次性将所有路由注册，左侧菜单树根据接口渲染，这种方式也算常用。但是这种方式的缺点就是可以在浏览器地址栏手动输入路由进入没有权限的页面，如果要解决这个问题就可以选择采用动态路由的方式来解决。</p>
<p>动态路由：根据不用用户（菜单）动态的注册应该有的路由，而不是一次性将所有的路由注册到 router 中。</p>
<ol>
<li>
<p>基于角色(role)动态路由管理</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">const</span> roles <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>每增加一个角色，都要多一个 key/value，前端该代码或者后端返回 json</p>
</li>
<li>
<p>基于菜单(menu)的动态路由管理，将菜单路由映射成路由对象</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token number">1.</span>获取菜单
<span class="token number">2.</span>动态获取所有的路由对象，放在数组
<span class="token number">3.</span>根据菜单去匹配正确的路由
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
</ol>
<p>动态添加路由</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token comment">//添加路由</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="实现多级面包屑" tabindex="-1"><a class="header-anchor" href="#实现多级面包屑" aria-hidden="true">#</a> 实现多级面包屑</h2>
<ul>
<li>多级面包屑结构 <code v-pre>[{一级},{二级},{三级},...]</code></li>
<li>菜单树结构<code v-pre>[{url:'',name:'',children:[{}]}]</code></li>
<li>当前路由 &quot;/main/son/gon&quot;，当前路由其实就是树的一个子节点</li>
<li>只有从树的 root，一直往下找，这一段就是需要的数据</li>
</ul>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token comment">//定义面包屑接口</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue-组件的-ref-类型" tabindex="-1"><a class="header-anchor" href="#vue-组件的-ref-类型" aria-hidden="true">#</a> vue 组件的 ref 类型</h2>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token comment">// &lt;el-form ref="formRef">&lt;/el-form>;</span>
